...
import { updateApplianceSelect, updateIngredientSelect, updateUstensilSelect } from "../utils/updateSelect.js";
...
export const drawLi = (value) => {
    ...
    li.onclick = (e) => {
        ...
        if (type === 'ingredients') {
            ...
            let ingredients = [...new Set(data.flatMap((recipe) => recipe.ingredients.flatMap((ing) => ing.ingredient.toLowerCase())))];
